  ...
  const features = [
    {
      ...
      title: 'Mortgage Support for Buyers',
      description:
        'Get connected with mortgage institutions offering clear, competitive plans tailored to your budget.',
    },
    {
      img: '/assets/images/growth-icon.png',
      title: 'Verified Applicants',
      description:
        'Work with pre-qualified and verified and verified candidates',
    },
    {
      img: '/assets/images/growth-icon.png',
      title: 'Strong Partnership',
      description: 'Build lasting relationships with trusted partners',
    },
  ]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-4">
            <motion.h2
              ...
              variants={fadeInUp}
            >
              Partner With Us to Find Vetted Applicants
            </motion.h2>
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Join our network of trusted mortgage institutions
            </motion.p>
          </div>
