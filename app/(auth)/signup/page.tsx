...
export default function SignupPage() {
  ...
  const [developerFormStep, setDeveloperFormStep] = useState<number>(1)
  ...
  const handleDeveloperStepChange = (currentStep: number) => {
    setDeveloperFormStep(currentStep)
  }

  const shouldHideImage =
    selectedRole === 'developer' && step === 'form' && developerFormStep === 2
    ...
    <div className="flex h-screen overflow-hidden md:ml-0 ml-[-30px] overflow-x-hidden">
      <motion.div
        className={`flex-1 p-10 w-full ${
          shouldHideImage ? 'lg:w-full' : 'lg:w-[55%]'
        } md:p-12 lg:p-16 flex flex-col overflow-y-auto px-8 py-10 transition-all duration-300`}
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <motion.div
          className={`w-full ${
            shouldHideImage ? 'max-w-4xl mx-auto' : 'max-w-md mx-auto ml-[50px]'
          ...
          {step === 'role-selection' ? (
            ...
            >
              {selectedRole === 'applicant' ? (
                ...
                <DeveloperSignupForm onStepChange={handleDeveloperStepChange} />
              )}
            </motion.div>
          )}
        </motion.div>
      ...
      {!shouldHideImage && (
        <motion.div
          className="hidden lg:flex lg:w-[40%] items-center justify-center bg-white p-6 scrollbar-hide overflow-x-hidden"
          initial={{ opacity: 1, x: 0 }}
          animate={{
            opacity: shouldHideImage ? 0 : 1,
            x: shouldHideImage ? 100 : 0,
          }}
          transition={{ duration: 0.3 }}
        >
              ...
              {selectedRole === 'developer' ? (
                <>
                  ...
                  <p className="text-sm mb-5 leading-relaxed text-center">
                    ...
                    projects, and connect with buyers across Nigeria. Expand
                    your reach and grow your business with our powerful
                    platform.
                  </p>
                ...
                <>
                  ...
                  <p className="text-sm mb-5 leading-relaxed">
                    ...
                    homes that match your lifestyle, preferences, and dreams —
